function optiEdificio(dcn, dca, dcp, dcc, dcu, dcf, dcr, alturaEdif, ps_base, superficieTerreno, superficieTerrenoBruta)
    ...
    @variables(m, begin
        ...
        0 <= estacionamientosBicicletasMin, Int
    ...
    @constraints(m, begin
        ...
        estacionamientosBicicletasMin <= estacionamientosNormales * dcn.ESTBICICLETAPOREST
        ...
        cambioEstBicicletas <= dcn.FLAGCAMBIOESTPORBICICLETA *estacionamientosVendiblesDesc / dcn.BICICLETASPOREST
        estacionamientosVendibles >= estacionamientosVendiblesDesc - cambioEstBicicletas
    ...
    if termination_status(m) == MOI.OPTIMAL
        status = true
        sn, sa, si, st, so, sm, sf = generaSalidaEntera(dcn, dca, dcp, dcc, dcu, dcf, dcr, alturaEdif, ps_base, superficieTerreno, 
